...
var G__21299 = o;
(G__21299[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__18358__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__18358__auto__){
var and__18358__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18358__auto____$1){
var and__18358__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__18358__auto____$2)){
...
var G__21307 = jsprops;
(G__21307["defaultValue"] = value);

(G__21307["onChange"] = ((function (G__21307,v,value,on_change){
return (function (p1__21305_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21305_SHARP_);
});})(G__21307,v,value,on_change))
);
...
var jsprops = {"argv": v};
var temp__4661__auto___21315 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___21315 == null)){
} else {
var key_21316 = temp__4661__auto___21315;
(jsprops["key"] = key_21316);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__21318 = (new reagent.impl.template.NativeWrapper());
(G__21318["name"] = c);
...
var len__19428__auto___21324 = arguments.length;
var i__19429__auto___21325 = (0);
while(true){
if((i__19429__auto___21325 < len__19428__auto___21324)){
args__19435__auto__.push((arguments[i__19429__auto___21325]));

var G__21326 = (i__19429__auto___21325 + (1));
i__19429__auto___21325 = G__21326;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19436__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21322){
var G__21323 = cljs.core.first.call(null,seq21322);
var seq21322__$1 = cljs.core.next.call(null,seq21322);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__21323,seq21322__$1);
});
...
break;
default:
var G__21330 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__21330;
continue;
...
var n__19273__auto___21331 = a.length;
var i_21332 = (0);
while(true){
if((i_21332 < n__19273__auto___21331)){
(a[i_21332] = reagent.impl.template.as_element.call(null,(a[i_21332])));

var G__21333 = (i_21332 + (1));
i_21332 = G__21333;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19273__auto___21334 = a.length;
var i_21335 = (0);
while(true){
if((i_21335 < n__19273__auto___21334)){
var val_21336 = (a[i_21335]);
if((cljs.core.vector_QMARK_.call(null,val_21336)) && ((reagent.impl.template.key_from_vec.call(null,val_21336) == null))){
(o["no-key"] = true);
} else {
}

(a[i_21335] = reagent.impl.template.as_element.call(null,val_21336));

var G__21337 = (i_21335 + (1));
i_21335 = G__21337;
continue;
} else {
}
...
var ctx = {};
var vec__21339 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21339,(0),null);
var derefed = cljs.core.nth.call(null,vec__21339,(1),null);
...
var G__21341 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21341) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__21341){
